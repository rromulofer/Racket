...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname 17-raizes-poly-Romulo) (read-case-sensitive #t) (teachpacks ((lib "gui.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #t #t none #f ((lib "gui.rkt" "teachpack" "htdp")) #f)))
